...
properties.Add("ixvendor_legal", {
	MenuLabel = "Change Vendor Legal Status",
	Order = 400,
	MenuIcon = "icon16/tag_blue_edit.png",
	...
	Action = function(self, entity)
		Derma_StringRequest("Revert Vendor Legal Status", "", "test", function(text)
			self:MsgStart()
			net.WriteEntity(entity)
			net.WriteString(text)
			self:MsgEnd()
	...
	Receive = function(self, length, client)
		...
		entity:OnChangedLegalStatus(text)
	end
})