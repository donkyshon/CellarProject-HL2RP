...
BILLIARD_GAMETYPE_SNOOKER = 0
BILLIARD_GAMETYPE_ROTATION = 1
BILLIARD_GAMETYPE_CARAMBOL = 2
BILLIARD_GAMETYPE_8BALL = 3
BILLIARD_GAMETYPE_9BALL = 4
BILLIARD_GAMETYPE_STREETBALL = 5
...
surface.CreateFont("HudCText", {font = "default",
   size = 35,
   weight = 700,
   antialias = true})
surface.CreateFont("HudCSubText", {font = "default",
   size = 18,
   weight = 700,
   antialias = true})
surface.CreateFont("HUDPoolText", {font = "default",
   size = 16,
   weight = 700,
   antialias = true})
...
function BilliardScrMsg()
	if(!b_scrTitle || b_scrTitle == "") then return hook.RemoveAll("CBilliardScrMsg") end
	b_w, b_h = ScrW() / 2, ScrH() / 2
	b_h = b_h + b_h / 2.5
...
function guiBilliardClientConfig()
	...
	b_client_panel:SetTitle("Snooker Client Configuration")
...
usermessage.Hook("billiard_setConfig", function(um)
	...
	AbModeBox:SetTextColor(Color(0, 0, 0))
	if(abmet == 0) then
	...
	gTLabel:SetTextColor(Color(0, 0, 0))
	...
	gTMultiChoice:AddChoice("Eight Ball")
	gTMultiChoice:AddChoice("Nine Ball")
  gTMultiChoice:AddChoice("Street Ball")
	...
	bTLabel:SetTextColor(Color(0, 0, 0))
	...
	FpModeBox:SetTextColor(Color(0, 0, 0))
	...
	ScModeBox:SetTextColor(Color(0, 0, 0))
	...
	TrModeBox:SetTextColor(Color(0, 0, 0))
	...
	MpModeBox:SetTextColor(Color(0, 0, 0))
...
usermessage.Hook("billiard_createMenu", function(um)
	...
	szLabel:SetTextColor(Color(0, 0, 0))
