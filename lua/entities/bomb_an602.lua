...
ENT.Model                            =  "models/sw/avia/bombs/an602.mdl"                      
...
ENT.SWOWNER                          =  nil             -- don't you fucking touch this.
ENT.Decal                            = "an602"
...
function ENT:Explode()
	 ...
	 ent:Spawn()
	 ent:Activate()
	 ent:SetVar("SWOWNER", self.SWOWNER)
	...
	if GetConVar("sw_nuclear_fallout"):GetInt()== 1 then
	 ...
	 ent:SetVar("DELAY",0.01)
	 ent:SetVar("SOUND", "sw/bombs/an602_detonate.mp3")
