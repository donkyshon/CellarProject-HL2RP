...
ArcCW.ClientConVars = {
    ["arccw_bullet_imaginary"]        = { def = 0 },

    ["arccw_crosshair"]               = { def = 0 },
    ...
    ["arccw_shelleffects"]            = { def =  0 },
    ["arccw_shelltime"]               = { def =  0 },
    ["arccw_att_showothers"]          = { def =  0 },
    ...
    ["arccw_vm_sway_sprint"]          = { def =  1 },
    ["arccw_vm_bob_sprint"]           = { def =  1 },
    ["arccw_vm_coolsway"]             = { def =  1 },
    ["arccw_vm_coolview"]             = { def =  0 },
    ["arccw_vm_coolview_mult"]        = { def =  0 },
    ["arccw_vm_accelmult"]            = { def =  1.5 },
    ["arccw_vm_lookxmult"]            = { def =  2 },
