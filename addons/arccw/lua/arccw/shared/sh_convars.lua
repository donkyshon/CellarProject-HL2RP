...
CreateConVar("arccw_enable_customization", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "")
CreateConVar("arccw_enable_dropping", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "")
...
CreateConVar("arccw_override_crosshair_off", 1, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Set to true to force everyone's crosshairs off.", 0, 1)
...
CreateConVar("arccw_holstering", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Take time to holster your weapon.")
